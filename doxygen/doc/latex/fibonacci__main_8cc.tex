...
\begin{center}
\leavevmode
\includegraphics[width=270pt]{fibonacci__main_8cc__incl}
\end{center}
\end{figure}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{fibonacci__main_8cc_a0ddf1224851353fc92bfbff6f499fa97}{main}} (int argc, char $\ast$argv\mbox{[}$\,$\mbox{]})
...
\index{fibonacci\_main.cc@{fibonacci\_main.cc}!main@{main}}
\index{main@{main}!fibonacci\_main.cc@{fibonacci\_main.cc}}
...
\href{https://stackoverflow.com/questions/21360694/sum-of-even-fibonacci-numbers-under-1000}{\texttt{ https\+://stackoverflow.\+com/questions/21360694/sum-\/of-\/even-\/fibonacci-\/numbers-\/under-\/1000}} exit 
\end{DoxySeeAlso}


Definition at line 25 of file fibonacci\+\_\+main.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{25                                   \{}
\DoxyCodeLine{26   \mbox{\hyperlink{fibonacci__sum_8cc_aeac332c082069f54e8769d311dd2049d}{Usage}}(argc, argv);}
\DoxyCodeLine{27   std::string limit = argv[1];}
\DoxyCodeLine{28   \textcolor{keyword}{const} \textcolor{keywordtype}{size\_t} kLimit = stoi(limit);}
\DoxyCodeLine{29   std::cout << \textcolor{stringliteral}{"Sum: "} << \mbox{\hyperlink{fibonacci__sum_8cc_adbea092e9a2442d7c23f17af8285b7d2}{fibonacci\_sum}}(kLimit) << std::endl; }
...
\begin{center}
\leavevmode
\includegraphics[width=243pt]{fibonacci__main_8cc_a0ddf1224851353fc92bfbff6f499fa97_cgraph}
\end{center}
\end{figure}
